...
const translations = {
    en: {
        ...
        footerText: "Your digital agriculture partner empowering farmers with technology."
    },
    ...
    ur: {
        ...
        footerText: "ٹیکنالوجی کے ذریعے کسانوں کو بااختیار بنانے والا ڈیجیٹل زرعی پلیٹ فارم۔"
    }
};
...
function toggleLanguage() {
    ...
    document.getElementById("hero-moto").innerText = t.heroMoto;

    document.getElementById("nav-weather").innerText = t.navWeather;
    document.getElementById("nav-mandi").innerText = t.navMandi;
    document.getElementById("nav-schemes").innerText = t.navSchemes;
    document.getElementById("nav-community").innerText = t.navCommunity;

    document.getElementById("weather-heading").innerHTML =
        `<img src="weather.png" class="icon"> ${t.weatherHeading}`;

    document.getElementById("weather-btn").innerText = t.weatherBtn;
